...
class SearchMediaAgeByBloodTypeCommand extends BaseCommand {
  final PeopleViewModel _viewModel;
  static final Signal<List<MediaAgeBloodTypeDto>> peopleMediaAgeByBloodType =
  signal<List<MediaAgeBloodTypeDto>>([]);
  static final Signal<bool> isLoading = signal<bool>(true);

  SearchMediaAgeByBloodTypeCommand(this._viewModel);

  @override
  Future<void> execute() async {
    isLoading.value = true;
    await _viewModel.searchMediaAgeByBloodType();
